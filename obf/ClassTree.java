...
import COM.rl.obf.classfile.ClassConstants.AttrSource;
...
public class ClassTree implements NameMapper
{
    ...
    private String mapSignature(String signature, AttrSource source) throws Exception
    {
     ...
     */
    @Override
    public String mapSignatureClass(String signature) throws Exception
    {
     ...
     */
    @Override
    public String mapSignatureMethod(String signature) throws Exception
    {
     ...
     */
    @Override
    public String mapSignatureField(String signature) throws Exception
    {
