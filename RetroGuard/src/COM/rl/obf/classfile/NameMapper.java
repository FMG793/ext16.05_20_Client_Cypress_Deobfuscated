...
public interface NameMapper
{
     ...
     * @throws Exception 
     */
    public String mapSignatureClass(String signature) throws ClassFileException, Exception;
     ...
     * @throws Exception 
     */
    public String mapSignatureMethod(String signature) throws ClassFileException, Exception;
     ...
     * @throws Exception 
     */
    public String mapSignatureField(String signature) throws ClassFileException, Exception;
}
