            ...
            if (!md.isFixed())
            {
                ...
                for (Enumeration nlEnum = nameListDowns.elements(); nlEnum.hasMoreElements(); )
                {
                    ...
                    if (theOutName != null)
                    {
                        ...
                        System.out.println((new StringBuilder("Method ")).append(md.getFullInName()).append(" renamed to ").append(theOutName).append(" because of derived class.").toString());
                        continue nextMethod;
                    }
                }
                ...
                for (Enumeration nlEnum = nameListUps.elements(); nlEnum.hasMoreElements(); )
                {
                    ...
                    if (theOutName != null)
                    {
                        md.setOutName(theOutName);
                        md.setIsOverride();
                        System.out.println((new StringBuilder("Method ")).append(md.getFullInName()).append(" renamed to ").append(theOutName).append(" because of super class.").toString());
                        continue nextMethod;
                    }
                }
                // If no other restrictions, obfuscate it
                if(NameProvider.currentMode == 0)
                {
                    md.setOutName(methodNameMaker.nextName(md.getInName(), md.getDescriptor()));
                    System.out.println((new StringBuilder("Method ")).append(md.getFullInName()).append(" renamed to ").append(md.getOutName()).append(" from name maker.").toString());
                } else
                {
            ...
            if (!fd.isFixed())
            {
                ...
                for (Enumeration nlEnum = nameListDowns.elements(); nlEnum.hasMoreElements(); )
                {
                    ...
                    if (theOutName != null)
                    {
                        ...
                        System.out.println((new StringBuilder("Field ")).append(fd.getFullInName()).append(" renamed to ").append(theOutName).append(" because of derived class.").toString());
                        continue nextField;
                    }
                }
                // Check for name reservation via super classes
                for (Enumeration nlEnum = nameListUps.elements(); nlEnum.hasMoreElements(); )
                {
                    ...
                    if (superOutName != null)
                    {
                        ...
                        fd.setIsOverride();
                        System.out.println((new StringBuilder("Field ")).append(fd.getFullInName()).append(" renamed to ").append(superOutName).append(" because of super class.").toString());
                        continue nextField;
                    }
                }
                // If no other restrictions, obfuscate it
                if(NameProvider.currentMode == 0)
                {
                    ...
                    System.out.println((new StringBuilder("Field ")).append(fd.getFullInName()).append(" renamed to ").append(fd.getOutName()).append(" from name maker.").toString());
                } else
                {
